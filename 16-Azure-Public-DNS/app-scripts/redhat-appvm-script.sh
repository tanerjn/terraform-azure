...
sudo echo "Welcome to Public DNS Demo - AppVM App1 - VM Hostname: $(hostname)" > /var/www/html/index.html
sudo echo "Welcome to Public DNS Demo - AppVM App1 - VM Hostname: $(hostname)" > /var/www/html/appvm/hostname.html
sudo echo "Welcome to Public DNS Demo - AppVM App1 - App Status Page" > /var/www/html/appvm/status.html
