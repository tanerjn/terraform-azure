...
sudo echo "Welcome to LB with metrics Demo - WebVM App1 - VM Hostname: $(hostname)" > /var/www/html/index.html
sudo mkdir /var/www/html/webvm
sudo echo "Welcome to LB with metrics Demo - WebVM App1 - VM Hostname: $(hostname)" > /var/www/html/webvm/hostname.html
sudo echo "Welcome to LB with metrics Demo - WebVM App1 - App Status Page" > /var/www/html/webvm/status.html
